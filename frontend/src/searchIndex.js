export default [
  {
    ...
    description: 'Lock System Documentation',
    details: 'Installation guides, maintenance tips, and troubleshooting for multi-point lock systems',
    path: '/documents',
    type: 'document'
  },
  {
  ...
  },
  {
    ...
    description: 'Web Operations Training',
    details: 'Training materials and SOPs for web operations',
    path: '/training/web',
    type: 'training'
  },
  {
    ...
    description: 'Product Image Guidelines',
    details: 'Canvas sizes, logo requirements, and image content guidelines',
    path: '/training/web#images',
    type: 'training'
  },
  {
    page: 'Training',
    title: 'Product Descriptions',
    description: 'Description Writing Guidelines',
    details: 'SEO optimization and content structure guidelines',
    path: '/training/web#descriptions',
    type: 'training'
  },
  {
    page: 'Training',
    title: 'FileMaker Records',
    description: 'Creating New Records',
    details: 'Step-by-step guide for creating records in FileMaker',
    path: '/training/web#filemaker',
    type: 'training'
  },
  {
    page: 'Training',
    title: 'Inventory vs Matrix Items',
    description: 'NetSuite Item Setup Guide',
    details: 'Understanding the difference between inventory and matrix items',
    path: '/training/web#inventory-vs-matrix',
    type: 'training'
  },
  {
    page: 'Training',
    title: 'Commerce Categories',
    description: 'NetSuite Category Management',
    details: 'Guide to managing commerce categories in NetSuite',
    path: '/training/web#commerce-categories',
    type: 'training'
  },
  {
    page: 'Training',
    title: 'Warehouse Navigation',
    description: 'Warehouse Layout Guide',
    details: 'Understanding the warehouse layout and bin number system',
    path: '/training/web#navigating-the-warehouse',
    type: 'training'
  },
  {
    page: 'Documents',
  ...
  {
    page: 'Training',
    title: 'Web Department Training',
    description: 'Training materials and SOPs for web operations',
    details: `Training materials and SOPs for web operations, content management, and digital processes:
  ...
  },
  {
    ...
    description: 'Guidelines, procedures, and training for customer support',
    details: `Customer service training materials including:
      - Support protocols
  ...
  },
  {
    ...
    description: 'Inventory management and receiving procedures',
    details: `Complete guide for new parts estimation:
      - Inventory management procedures
      - Receiving guidelines
      - Warehouse operations
      - Parts cataloging process`,
  ...
  },
  {
    ...
    description: 'Shipping procedures and packaging guidelines',
    details: `Shipping department training materials:
  ...
  },
  {
    ...
    description: 'Receiving procedures and warehouse operations',
    details: `Receiving department training materials:
